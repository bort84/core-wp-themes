...
After successful upload of SVG with sizing data it is actually possible to deactivate the plugin and still use.
...
* NOTE: It has been found that SimpleXML used to parse XML to get metadata fails to parse XML 1.1 for me this was simple. Change reported XML version to 1.0. Check before actioning yourself
